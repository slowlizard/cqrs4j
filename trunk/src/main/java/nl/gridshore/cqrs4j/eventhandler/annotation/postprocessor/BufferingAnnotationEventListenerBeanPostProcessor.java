 ...
 * @see TransactionalBufferingAnnotationEventListenerBeanPostProcessor
 ...
 * @since 0.1
 */
public class BufferingAnnotationEventListenerBeanPostProcessor extends BaseAnnotationEventListenerBeanPostProcessor {
