...
public abstract class AbstractAnnotatedAggregateRoot extends AbstractAggregateRoot implements AggregateRoot {
    ...
    /**
     * Calls the appropriate {@link nl.gridshore.cqrs.eventhandler.annotation.EventHandler} annotated handler with the
     * provided event.
     *
     ...
     * event. Throws an {@link nl.gridshore.cqrs.eventhandler.annotation.UnhandledEventException}.
     *
