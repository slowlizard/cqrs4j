...
/**
 * Extension on the {@link nl.gridshore.cqrs4j.eventhandler.EventListener} interface that provides implementations the
...
public interface TransactionAware {
     ...
     * nl.gridshore.cqrs4j.eventhandler.TransactionStatus} may be used to set the maximum batch size for the current
     * transaction.
     *
     * @param transactionStatus The current status of the transaction
     * @see #afterTransaction(TransactionStatus)
     * @see nl.gridshore.cqrs4j.eventhandler.TransactionStatus
     */
     ...
     * nl.gridshore.cqrs4j.eventhandler.TransactionStatus} may be used to indicate whether the scheduler should yield to
     ...
     * occurred. Use the {@link nl.gridshore.cqrs4j.eventhandler.TransactionStatus} object to find information about
